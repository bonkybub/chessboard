...
public:
	...
	void SetTextureAnimation(int frameSizeX, int frameSizeY, int framesPerSecond, int numFrames = -1);
	...
	// tell it to mirror horizontally
	void SetMirrorHorizontal(bool mirror) { bMirror = mirror; }
